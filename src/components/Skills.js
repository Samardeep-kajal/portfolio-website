...
const Skills = () => {
  return (
    <div className="font-Poppins mt-48 ml-36 w-3/4">
      <h1 className="text-3xl ml-24 underline">Skills</h1>
      <h1 className="mt-5 underline ml-28 text-2xl">Full Stack</h1>
      ...
      {/* LANGUAGE Section */}
      <h1 className="mt-10 ml-28 underline text-2xl">Languages</h1>
      ...
      <h1 className="mt-10 ml-28 underline text-2xl">Tools</h1>
      <div className="mt-3 justify-evenly flex flex-row flex-wrap">
        <div className="logo-card">
